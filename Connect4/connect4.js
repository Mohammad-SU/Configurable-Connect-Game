...
function setPiece() {
    ...
    function setPiece_main() {
        ...
        if (swapEnabled) { // Swap colours and pieces when the swapRound is reached
            if (rounds == swapRound) {
                $(".tile").each(function() {
        ...
        function changeColumns_checkWinner(rVal, cVal) { // rVal and cVal indicate the positions of the extra tile in the board array if the gamemode is enabled
